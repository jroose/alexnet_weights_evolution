...
if __name__ == '__main__':
    ...
    BATCH_SIZE = 256 #baseline BATCH_SIZE is 256, try smaller sizes 32, 64
    image_width = 227
    image_height = 227
...
#    )
    ...
    model.fit(Train_ds.prefetch(2), validation_data=Valid_ds.prefetch(2), epochs = 300, callbacks=[tb])
